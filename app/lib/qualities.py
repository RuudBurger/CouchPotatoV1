...
class Qualities:
    ...
    types = {
        'blu':    {'key': 'blu', 'size': (15000, 60000), 'order':1, 'label': 'blu-ray', 'alternative': ['blu-ray', 'bluray', '1080p'], 'allow': ['bluray', '1080p'], 'ext':['mkv', 'm2ts']},
        ...
        'scr':      {'key': 'scr', 'size': (600, 1600), 'order':7, 'label': 'Screener', 'alternative': ['dvdscr', 'ppvrip'], 'allow': ['dvdr'], 'ext':['avi', 'mpg', 'mpeg']},
